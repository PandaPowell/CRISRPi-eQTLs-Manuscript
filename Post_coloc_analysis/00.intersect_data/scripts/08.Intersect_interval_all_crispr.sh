...
echo "GWAS_variant,region,chr,finemap_snp_intersect_grna,SS_coord,gwas,eQTL_variant,PP.H0.abf,PP.H1.abf,PP.H2.abf,PP.H3.abf,PP.H4.abf,nsnps,gwas_credible_set,eqtl_credible_set,SNP.PP.H4,chr.x
,pos.x,a0.x,a1.x,minor_allele,minor_AF,low_confidence_variant,n_complete_samples,AC,ytx,beta.x,se,tstat,pval,Chr,Pos,_NUM_ID_.ss.x,rsid.x,_NUM_ID_.x,varbeta.x,z.x,chr.y,pos.y,a0.y,a1.y,snp_hg
38.x,lower_hg38,upper_hg38,rsid.ss,lower_hg19,upper_hg19,phenotype_id,variant_id,tss_distance,af,ma_samples,ma_count,pval_nominal,beta.y,slope_se,_NUM_ID_.ss.y,rsid.y,_NUM_ID_.y,varbeta.y,z.y
,trait,region.x,method,gwas_name" > "stingseq_eqtl_overlap/${eqtl}_coloc_stingseq.txt"
