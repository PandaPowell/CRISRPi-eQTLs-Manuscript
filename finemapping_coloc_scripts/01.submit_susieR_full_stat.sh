...
for file_num in $(seq -w 30000 30300); do
	...
	mkdir -p "/gpfs/commons/groups/lappalainen_lab/sghatan/stingseq_eqtl_overlap/results/UKBB_SuSiE_finemap_lbf/${file_num}"

        Rscript 01.susie_finemap_full_stats.R \
                "$formatted_file" \
